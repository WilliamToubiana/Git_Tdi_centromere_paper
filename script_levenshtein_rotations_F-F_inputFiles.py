...
file_path_2 = "Enriched_2kbmotifs_enriched_10kb_regions.txt"  # Replace with the path to your second input file
sequences_2 = {}
...
output_file_path = "levenstein_distances_FF.txt"  # Replace with your desired output file path
